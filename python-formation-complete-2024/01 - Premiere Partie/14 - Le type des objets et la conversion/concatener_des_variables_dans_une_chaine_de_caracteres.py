...
Concaténer des variables dans une chaîne de caractères
    ...
    Par exemple, si je change la valeur de a pour 5 au lieu de 2, la variable resultat devra donc contenir 
    la chaîne de caractères "5 + 6 + 3" au lieu de "2 + 6 + 3".
